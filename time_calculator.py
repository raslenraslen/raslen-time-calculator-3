def add_time(start, duration, day_of_week=False):
  days_of_week_index = {"monday": 0, "tuesday": 1, "wednesday": 2,   
  "thursday": 3, "friday": 4, "saturday": 5, "sunday": 6}
  days_of_week_array = ["Monday", "Tuesday", "Wednesday", "Thursday", 
  "Friday", "Saturday", "Sunday"]
  duration_tuple = duration.partition(":")
  duration_hours = int(duration_tuple[0])
  duration_minutes = int(duration_tuple[2])

  start_tuple = start.partition(":")  # Corrected from duration to start
  ...
  if day_of_week:
    ...
    index = (days_of_week_index[day_of_week] + amount_of_days) % 7
